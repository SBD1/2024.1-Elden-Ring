...
CREATE TYPE IF NOT exists funcao_p AS enum ('Inimigo', 'Ferreiro', 'Chefe', 'Mercador', 'Campones');

CREATE TYPE IF NOT exists tipo_atk AS enum ('Fogo', 'Raio', 'Magia', 'Cortante', 'Contusao');

CREATE TYPE IF NOT exists tipo_p AS enum ('Jogavel', 'Njogavel');
...
--    proficiencia INTEGER(255) ARRUMAR TIPO DEPOIS
);
